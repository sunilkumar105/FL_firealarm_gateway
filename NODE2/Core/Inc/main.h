...
#define MANUAL_STOP_ALARM_pin_Pin GPIO_PIN_10
#define MANUAL_STOP_ALARM_pin_GPIO_Port GPIOB
#define ALARM_HOOTER_pin_Pin GPIO_PIN_4
#define ALARM_HOOTER_pin_GPIO_Port GPIOB
#define ALARM_LED_pin_Pin GPIO_PIN_5
#define ALARM_LED_pin_GPIO_Port GPIOB
